...
#include "main.h"   // Examples Include File
...
void InitPeripheralClocks(void)
{
	...
	SysCtrlRegs.HISPCP.all = 0x0001;	// H = SYSCLKOUT / 2 = 75 MHz 
	SysCtrlRegs.LOSPCP.all = 0x0002;	// L = SYSCLKOUT / 4 = 37.5 MHz
	...
	SysCtrlRegs.PCLKCR3.bit.XINTFENCLK = 1;     // XINTF ±÷” ±ƒ‹
