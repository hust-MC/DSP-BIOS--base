...
-u L4SARAM
RTDX_DATAMEMSEG = L4SARAM;

-u L4SARAM
HST_DSMBUFSEG = L4SARAM;
...
MEMORY {
   ...
   PAGE 0:   FLASH_ABCDEFGH: origin = 0x300000,  len = 0x3ff80
...
SECTIONS {
   .clk: {
        ...
        *(.clk) 
   } > L4SARAM  PAGE 1, RUN_START(CLK_A_TABBEG) 
}
_CLK_PRD = CLK_PRD;
...
SECTIONS {
   .idl: {
        *(.idl) 
   } > L4SARAM PAGE 1, RUN_START(IDL_A_TABBEG)
   
   .idlcal: {
        *(.idlcal) 
   } > L4SARAM PAGE 1, RUN_START(IDL_A_CALBEG) 
}
...
SECTIONS {
       ...
       /* no HWI stubs are necessary */
        ...
        } load > FLASH_ABCDEFGH PAGE 0, run > L0123SARAM PAGE 1

        .bss:     {} > L4SARAM PAGE 1

        .sysdata: {} > L4SARAM PAGE 1
        ...
        .sysregs: {} > L4SARAM PAGE 1

        .ebss:     {} > L4SARAM PAGE 1

        .rtdx_data: {}  > L4SARAM PAGE 1

        .hwi_disp_sec:     {} > L4SARAM PAGE 1
        ...
        /* LOG_system buffer */
        .LOG_system$buf: align = 0x80 {} > L4SARAM PAGE 1

        /* trace buffer */
        .trace$buf: align = 0x40 {} > L4SARAM PAGE 1

        /* LOG_trace buffer */
        .LOG_trace$buf: align = 0x80 {} > L4SARAM PAGE 1
       ...
       /* RTA_fromHost buffer */
       .hst1: align = 0x4 {} > L4SARAM PAGE 1

       /* RTA_toHost buffer */
       .hst0: align = 0x4 {} > L4SARAM PAGE 1
        ...
        .L4SARAM$heap: {
            . += 0x200;
        } RUN_START(L4SARAM$B), RUN_START(_L4SARAM_base), RUN_SIZE(L4SARAM$L), RUN_SIZE(_L4SARAM_length) > L4SARAM PAGE 1
